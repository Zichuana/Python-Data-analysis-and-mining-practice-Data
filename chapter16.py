...
# 属性变换
# 参数初始化
discfile = './data_chapter16/discdata.xls'  # 磁盘原始数据
transformeddata = './data_chapter16/discdata_processed.xls'  # 变换后的数据
...
# 参数初始化
discfile = './data_chapter16/discdata_processed.xls'
...
# 计算预测误差
# 参数初始化
file = './data_chapter16/predictdata.xls'
