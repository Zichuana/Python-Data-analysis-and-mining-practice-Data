...
# 属性变换
# 参数初始化
discfile = './data_chapter14/discdata.xls'  # 磁盘原始数据
transformeddata = './data_chapter14/discdata_processed.xls'  # 变换后的数据
...
# 平稳性检验
# 参数初始化
discfile = './data_chapter14/discdata_processed.xls'
...
print(acorr_ljungbox(data['CWXT_DB:184:D:\\'], lags=1))
lb, p = 19.519264, 0.00001
if p < 0.05:
...
print(acorr_ljungbox(data['CWXT_DB:184:D:\\'].diff().dropna(), lags=1))
lb, p = 2.493321, 0.11433
if p < 0.05:
...
bic_matrix = [[1275.6868239439104, 1273.190434524266, 1273.5749982328914, 1274.4669152438114, None],
...
# 计算预测误差
# 参数初始化
file = './data_chapter14/predictdata.xls'
